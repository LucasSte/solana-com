...
<Callout type="info">
  ...
  серіалізації для програм Solana.
</Callout>
...
Кожна програма Solana має точку входу, яка є функцією, що викликається при
...
Точка входу програми Solana `entrypoint` має наступний підпис функції.
...
Solana, ми використаємо Cross Program Invocation (CPI), по суті викликаючи іншу
...
LiteSVM імітує середовище виконання Solana, дозволяючи нам тестувати нашу
