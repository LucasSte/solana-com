...
Elk Solana-programma heeft een entrypoint, dit is de functie die wordt
...
Een Solana-programma `entrypoint` heeft de volgende functiehandtekening.
...
Solana, gebruiken we een Cross Program Invocation (CPI), waarbij we in feite een
...
basisstructuur toont die alle Solana-programma's delen:
