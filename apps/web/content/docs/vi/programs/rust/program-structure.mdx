...
<Callout type="info">
  ...
  sử dụng phổ biến cho các chương trình Solana.
</Callout>
...
Mỗi chương trình Solana đều có một điểm vào, đó là hàm được gọi khi chương trình
...
Một `entrypoint` của chương trình Solana có chữ ký hàm sau đây. Các nhà phát
...
Chúc mừng! Bạn đã xây dựng một chương trình Solana hoàn chỉnh thể hiện cấu trúc
