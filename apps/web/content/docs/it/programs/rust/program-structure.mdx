...
<Callout type="info">
  ...
  serializzazione comunemente utilizzata per i programmi Solana.
</Callout>
...
Ogni programma Solana ha un punto di ingresso, che è la funzione che viene
...
Congratulazioni! Hai creato un programma Solana completo che dimostra la
...
LiteSVM simula l'ambiente di runtime di Solana, permettendoci di testare il
