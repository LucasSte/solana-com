...
προγράμματος Solana. Χρειαζόμαστε το `solana-program` για το βασικό SDK και το
...
<Callout type="info">
  ...
  χρησιμοποιούμενη βιβλιοθήκη σειριοποίησης για προγράμματα Solana.
</Callout>
...
Κάθε πρόγραμμα Solana έχει ένα σημείο εισόδου, το οποίο είναι η συνάρτηση που
...
λογαριασμούς στη Solana, θα χρησιμοποιήσουμε μια Cross Program Invocation (CPI),
...
Συγχαρητήρια! Έχετε δημιουργήσει ένα πλήρες πρόγραμμα Solana που επιδεικνύει τη
βασική δομή που μοιράζονται όλα τα προγράμματα Solana:
...
Το LiteSVM προσομοιώνει το περιβάλλον εκτέλεσης του Solana, επιτρέποντάς μας να
...
[Solana Explorer](https://explorer.solana.com/?cluster=custom) χρησιμοποιώντας
