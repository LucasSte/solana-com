...
<Callout type="info">
  ...
  serializacji dla programów Solana.
</Callout>
...
Każdy program Solana ma punkt wejścia, który jest funkcją wywoływaną podczas
...
Gratulacje! Zbudowałeś kompletny program Solana, który demonstruje podstawową
strukturę wspólną dla wszystkich programów Solana:
...
LiteSVM symuluje środowisko wykonawcze Solana, umożliwiając testowanie naszego
...
[Solana Explorer](https://explorer.solana.com/?cluster=custom) używając podpisów
