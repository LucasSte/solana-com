...
compteur. Comme seul le System Program peut créer des comptes sur Solana, nous
...
Félicitations ! Vous avez construit un programme Solana complet qui démontre la
