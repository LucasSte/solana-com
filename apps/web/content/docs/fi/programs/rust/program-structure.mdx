...
<Callout type="info">
  ...
  serialisointikirjasto Solana-ohjelmissa.
</Callout>

## !!steps Määritä crate-type

Solana-ohjelmat täytyy kääntää dynaamisina kirjastoina. Lisää `[lib]` osio
...
Jokaisella Solana-ohjelmalla on sisääntulopiste, joka on funktio jota kutsutaan
...
Solana-ohjelman `entrypoint` funktiolla on seuraava funktiosignature. Kehittäjät
...
Onnittelut! Olet rakentanut kokonaisen Solana-ohjelman, joka demonstroi kaikkien
Solana-ohjelmien jakamaa perusrakennetta:
...
[Solana Explorerissa](https://explorer.solana.com/?cluster=custom) käyttämällä
