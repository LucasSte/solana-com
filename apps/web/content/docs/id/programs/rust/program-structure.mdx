...
Solana. Kita membutuhkan `solana-program` untuk SDK inti dan `borsh` untuk
serialisasi.
...
Setiap program Solana memiliki entrypoint, yaitu fungsi yang dipanggil saat
...
Sebuah `entrypoint` program Solana memiliki tanda tangan fungsi berikut.
...
Pola perutean ini umum dalam program Solana. `instruction_data` dideserialkan
...
baru. Karena hanya System Program yang dapat membuat akun di Solana, kita akan
...
[Solana Explorer](https://explorer.solana.com/?cluster=custom) menggunakan tanda
